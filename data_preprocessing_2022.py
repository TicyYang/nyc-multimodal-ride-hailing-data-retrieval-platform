...
fhvhv_202201 = pd.read_parquet('../fhvhv_tripdata_2022-01.parquet', engine='pyarrow')
fhvhv_202202 = pd.read_parquet('../fhvhv_tripdata_2022-02.parquet', engine='pyarrow')
fhvhv_202203 = pd.read_parquet('../fhvhv_tripdata_2022-03.parquet', engine='pyarrow')
# fhvhv_202204 = pd.read_parquet('../fhvhv_tripdata_2022-04.parquet', engine='pyarrow')
# fhvhv_202205 = pd.read_parquet('../fhvhv_tripdata_2022-05.parquet', engine='pyarrow')
# fhvhv_202206 = pd.read_parquet('../fhvhv_tripdata_2022-06.parquet', engine='pyarrow')

fhvhv = pd.concat([fhvhv_202201, fhvhv_202202, fhvhv_202203]).reset_index(drop=True)
...
yellow_202201 = pd.read_parquet('../yellow_tripdata_2022-01.parquet', engine='pyarrow')
yellow_202202 = pd.read_parquet('../yellow_tripdata_2022-02.parquet', engine='pyarrow')
yellow_202203 = pd.read_parquet('../yellow_tripdata_2022-03.parquet', engine='pyarrow')
# yellow_202204 = pd.read_parquet('../yellow_tripdata_2022-04.parquet', engine='pyarrow')
# yellow_202205 = pd.read_parquet('../yellow_tripdata_2022-05.parquet', engine='pyarrow')
# yellow_202206 = pd.read_parquet('../yellow_tripdata_2022-06.parquet', engine='pyarrow')
yellow = pd.concat([yellow_202201, yellow_202202, yellow_202203])
yellow = yellow.sort_values('tpep_pickup_datetime').reset_index(drop=True)
yellow = yellow.rename(columns={'tpep_pickup_datetime': 'pickup_datetime',
                                'tpep_dropoff_datetime': 'dropoff_datetime',
                                'trip_distance': 'trip_miles'})
# yellow = yellow[yellow['pickup_datetime'].dt.to_period('M').isin(['2022-01', '2022-02', '2022-03'])]
...
del fhvhv_202201, fhvhv_202202, fhvhv_202203
del yellow_202201, yellow_202202, yellow_202203
# %% 查看各Dataset紀錄數
...
# %% 檢查小黃的日期時間
yellow = yellow[(yellow['pickup_datetime'].dt.to_period('M') == '2022-01') | 
           (yellow['pickup_datetime'].dt.to_period('M') == '2022-02') |
           (yellow['pickup_datetime'].dt.to_period('M') == '2022-03')]
...
# XGBRegressor: n_estimators=1000, learning_rate=0.1, n_jobs=-1, random_state=0)
...
# 擬合X, y
history = model.fit(X_train, y_train, validation_split=0.3, batch_size=5, epochs=20, verbose=2)
