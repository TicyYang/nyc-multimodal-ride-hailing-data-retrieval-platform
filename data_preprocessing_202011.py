...
# 拆分Uber和Lyft
uber_202011 = fhvhv_202011[fhvhv_202011.hvfhs_license_num == 'HV0003']
lyft_202011 = fhvhv_202011[fhvhv_202011.hvfhs_license_num == 'HV0005']

# 刪除原本的fhvhv
del fhvhv_202011
# %% 查看各Dataset紀錄數
total_records = uber_202011.shape[0] + lyft_202011.shape[0] + yellow_202011.shape[0] + green_202011.shape[0]

print(f'Uber: {uber_202011.shape[0]} {round(uber_202011.shape[0]/total_records*100, 2)}%')
print(f'Lyft: {lyft_202011.shape[0]} {round(lyft_202011.shape[0]/total_records*100, 2)}%')
print(f'Yellow: {yellow_202011.shape[0]} {round(yellow_202011.shape[0]/total_records*100, 2)}%')
print(f'Green: {green_202011.shape[0]} {round(green_202011.shape[0]/total_records*100, 2)}%')
...
del total_records
# %% 取需要的column
uber_202011 = uber_202011.loc[:, ['pickup_datetime', 'dropoff_datetime', 'PULocationID',
                                  'DOLocationID', 'trip_miles', 'trip_time',
                                  'base_passenger_fare']]
lyft_202011 = lyft_202011.loc[:, ['pickup_datetime', 'dropoff_datetime', 'PULocationID',
                                  'DOLocationID', 'trip_miles', 'trip_time',
                                  'base_passenger_fare']]
yellow_202011 = yellow_202011.loc[:, ['tpep_pickup_datetime', 'tpep_dropoff_datetime', 'trip_distance',
                                      'PULocationID', 'DOLocationID', 'fare_amount']]
green_202011 = green_202011.loc[:, ['lpep_pickup_datetime', 'lpep_dropoff_datetime', 'trip_distance',
                                    'PULocationID', 'DOLocationID', 'fare_amount']]

# %% 欄位改名
# Uber、Lyft行程時間、車資欄位改名
uber_202011 = uber_202011.rename(columns={'trip_time': 'trip_time(s)',
                                          'base_passenger_fare': 'base_fare'})
lyft_202011 = lyft_202011.rename(columns={'trip_time': 'trip_time(s)',
                                          'base_passenger_fare': 'base_fare'})

# 小黃、小綠上車時間、下車時間、行駛距離、車資欄位改名
yellow_202011 = yellow_202011.rename(columns={'tpep_pickup_datetime': 'pickup_datetime',
                                              'tpep_dropoff_datetime': 'dropoff_datetime',
                                              'trip_distance': 'trip_miles',
                                              'fare_amount': 'base_fare'})
green_202011 = green_202011.rename(columns={'lpep_pickup_datetime': 'pickup_datetime',
                                            'lpep_dropoff_datetime': 'dropoff_datetime',
                                            'trip_distance': 'trip_miles',
                                            'fare_amount': 'base_fare'})
# %% 檢查缺失值
print('-----Uber-----')
print(uber_202011.info(show_counts=True))
print('\n-----Lyft-----')
print(lyft_202011.info(show_counts=True))
print('\n-----Yellow-----')
print(yellow_202011.info(show_counts=True))
print('\n-----Green-----')
print(green_202011.info(show_counts=True))

# %% 檢查小黃、小綠的日期時間
yellow_wrong_time = yellow_202011[yellow_202011['pickup_datetime'].dt.to_period('M') != '2020-11']
...
# 其餘48筆日期差距較大，應予刪除
yellow_202011 = yellow_202011[yellow_202011['pickup_datetime'].dt.to_period('M') == '2020-11']
del yellow_wrong_time, yellow_wrong_time_1031, yellow_wrong_time_1201

green_wrong_time = green_202011[green_202011['pickup_datetime'].dt.to_period('M') != '2020-11']
...
green_202011 = green_202011[green_202011['pickup_datetime'].dt.to_period('M') == '2020-11']
del green_wrong_time

# %% 計算小黃、小綠的行程時間
yellow_202011['trip_time(s)'] = yellow_202011['dropoff_datetime'] - yellow_202011['pickup_datetime']
yellow_202011['trip_time(s)'] = round(yellow_202011['trip_time(s)'] / np.timedelta64(1, 's'), 0)

green_202011['trip_time(s)'] = green_202011['dropoff_datetime'] - green_202011['pickup_datetime']
green_202011['trip_time(s)'] = round(green_202011['trip_time(s)'] / np.timedelta64(1, 's'), 0)
# %% 檢查未知上車地點佔整體資料比例
...
check_unknown_pu_zone(uber_202011)

print('Lyft num of unknown pickup zone')
check_unknown_pu_zone(lyft_202011)

print('Yellow num of unknown pickup zone')
check_unknown_pu_zone(yellow_202011)

print('Green num of unknown pickup zone')
check_unknown_pu_zone(green_202011)
...
uber_202011 = remove_unknown_pu_zone(uber_202011)
lyft_202011 = remove_unknown_pu_zone(lyft_202011)
yellow_202011 = remove_unknown_pu_zone(yellow_202011)
...
check_unknown_do_zone(uber_202011)

print('Lyft num of unknown drop off zone')
check_unknown_do_zone(lyft_202011)

print('Yellow num of unknown drop off zone')
check_unknown_do_zone(yellow_202011)

print('Green num of unknown drop off zone')
check_unknown_do_zone(green_202011)
...
uber_202011 = remove_unknown_do_zone(uber_202011)
lyft_202011 = remove_unknown_do_zone(lyft_202011)
yellow_202011 = remove_unknown_do_zone(yellow_202011)
green_202011 = remove_unknown_do_zone(green_202011)
...
uber_202011 = merge_with_tz(uber_202011)
lyft_202011 = merge_with_tz(lyft_202011)
yellow_202011 = merge_with_tz(yellow_202011)
green_202011 = merge_with_tz(green_202011)
...
for df in [uber_202011, lyft_202011, yellow_202011]:
    print('------------------------------')
...
sns.histplot(lyft_202011['trip_time(s)'], color='red', alpha=0.7, label='Lyft')
sns.histplot(yellow_202011['trip_time(s)'],
             color='yellow', alpha=0.7, label='Yellow')
sns.histplot(green_202011['trip_time(s)'],
...
#%%% 組合
all_data = pd.concat([uber_202011, lyft_202011, yellow_202011, green_202011])
...
plt.title('Num of service type - per hour', fontdict={'fontsize': 18})
plt.xlabel('Hour', fontdict={'fontsize': 16})
